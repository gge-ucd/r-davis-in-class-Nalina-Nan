...
#should not have pipe at the end
#you can filter them in the same line using weight<60&weight>30
...
#good point using na.rm and arrange
#I am not sure I understood the command correctly, should we ask to find the smallest cricket in the biggest tibbie? if that so,arrange (asc(max_weigh)) would be more correct.... But when I run the code there are a lot on -inf. But thumb up on it, I could not reach this point in my code.
...
#good poind using species_id instead of species 
